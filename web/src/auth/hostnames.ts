 ...
 * notes.aicountly.com and notes.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'notes').trim() || 'notes'
...
/**
 * `notes.aicountly.com` and `notes.gh.aicountly.com` both resolve to
 * `notes`, which is what the portal expects in authentication_jump.
 */
